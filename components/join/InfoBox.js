      ...
      <div className="flex justify-center mt-10">
        ...
        >
          <div className="mt-10 text-center">
            <p className="large-bold-text">
              Join a community of creators in our
            </p>
            <h6 className="flex items-center mb-16 px-2">
              Awesome Slack Community
        ...
        <div className="hidden laptop:flex laptop:justify-between laptop:m-7 max-w-[1700px]">
          <div className="px-14 py-10 bg-black/40 rounded-2xl">
            ...
            <h6 className="mb-12 flex items-center">
              Awesome Slack Community{" "}
              <span className="ml-7 flex items-center">
                <Image className="text-black" src={slackImg} alt="imageicon" />
              </span>
            </h6>
            <div className="laptop:grid laptop:grid-rows-2 laptop:grid-cols-2 laptop:gap-10">
              ...
              <InfoTicket
                img={collaborative}
                title="Collaborative Knowledge"
                description="Exclusive exposure to industry experts & an opportunity to learn from them."
              />
              <InfoTicket
                img={feedback}
                title="Instant Feedback"
              ...
              <InfoTicket
                img={events}
                title="Skill-Building Events"
                description="Participate in high-quality, engaging events and learn skills."
              />
            </div>
          </div>
          <SlackForm />
