      ...
      <>
        <div className="laptop:hidden block">
          <div className="mx-6 mb-12">
            <h5 className="mb-8 font-cabin font-bold laptop:text-[20px] text-[18px] capitalize">{props.label}</h5>
            <input
              className="input-form-1 w-5/6"
              placeholder={props.placeholder}
            />
          </div>
          <div className="flex gap-9 flex-wrap mx-6">
            <div>
              <div className="small-inline-text">
                {props.progress}% completed
              </div>
              <progress
                className="progress-1 w-[100px]"
        ...
        <div
          className="hidden w-full mx-12 mb-20 mt-24
        ...
        >
          <div>
            ...
            <input className="input-form-1" placeholder={props.placeholder} />
          </div>
